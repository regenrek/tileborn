...
- System requirements, installation, checksum verification, project backup,
  manual rollback, known limitations, and support boundary are current.
...
- Project backup/reopen and retained-installer rollback oracle passes.
