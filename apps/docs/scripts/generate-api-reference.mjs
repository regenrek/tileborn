...
const PUBLIC_PACKAGES = [
  ...
  },
  {
    ...
    description:
      'Native TypeScript gameplay behavior API, deterministic context, references, and test harness.',
  },
  {
    id: 'plugin-api',
...
const generatePackageReference = (pkg) => {
  ...
  if (!fs.existsSync(typedocBin)) {
    throw new Error(
      `TypeDoc binary not found at ${typedocBin}. Run pnpm install in the monorepo root.`,
    );
  }
