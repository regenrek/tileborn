...
export const PERSISTED_SCHEMA_REGISTRY: readonly PersistedSchemaRegistration[] = [
  ...
  versioned('projectImportRecords', {
    ...
    codecOwner: 'packages/services-app/src/project/index.ts#appendImportRecord',
    migrationOwner: 'packages/services-app/src/project/index.ts#appendImportRecord',
  ...
  versioned('tilesetManifest', {
    ...
    codecOwner: 'packages/sdk-tileset/src/manifest/schema-version.ts#TilesetPackManifest',
  ...
  versioned('assetLibraryIndex', {
    ...
    codecOwner: 'packages/services-app/src/asset-library/index.ts#AssetLibraryIndexDocument',
  ...
  versioned('userInputOverlay', {
    ...
    codecOwner: 'packages/core/src/input/index.ts#InputMap',
    migrationOwner: 'apps/desktop/src/renderer/lib/playtest-user-bindings.ts',
  ...
  versioned('userHudOverlay', {
    ...
    codecOwner: 'packages/core/src/hud/index.ts#HudLayout',
  ...
  },
  {
    ...
    codecOwner: 'packages/services-build/src/model.ts#BuildArtifact/ExportArtifact',
