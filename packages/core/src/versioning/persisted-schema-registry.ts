...
export const PERSISTED_SCHEMA_REGISTRY: readonly PersistedSchemaRegistration[] = [
  ...
  versioned('deploymentManifest', {
    versionLocation: 'payload',
    durability: 'shipped-artifact',
    storage: '<shipped-game>/deployment.json',
    codecOwner: 'apps/game-host/src/build/deployment-manifest.ts#DeploymentManifest',
    migrationOwner: 'apps/game-host/src/build/deployment-manifest.ts',
    compatibility: strictCurrent(PERSISTED_SCHEMA_VERSIONS.deploymentManifest),
  }),
  ...
  versioned('audioUserSettings', {
    versionLocation: 'storage-key',
    durability: 'user-preference',
    storage: 'localStorage tileborne.game-client.audio-settings.v1',
    codecOwner:
      'packages/game-client/src/audio/user-audio-settings.ts#createAudioUserSettingsStore',
    migrationOwner: 'packages/game-client/src/audio/user-audio-settings.ts',
    compatibility: resettable(PERSISTED_SCHEMA_VERSIONS.audioUserSettings),
  }),
