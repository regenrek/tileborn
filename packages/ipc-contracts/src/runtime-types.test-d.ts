...
export type ClientRequestIsDecoded = Assert<
  Equal<ProjectsGetClientRequest, DecodedProjectsGetRequest>
>;
...
export type ClientProjectIdIsBranded = Assert<
  Equal<ProjectsGetClientRequest['projectId'], ProjectId>
>;

export type HandlerRequestIsDecoded = Assert<
  Equal<ProjectsGetHandlerRequest, DecodedProjectsGetRequest>
>;
export type ByChannelRequestIsDecoded = Assert<
  Equal<ProjectsGetContractRequest, DecodedProjectsGetRequest>
>;
...
>;
export type RuntimePlaytestReloadIsBoolean = Assert<
  Equal<RuntimePlaytestInputRequest['reload'], boolean>
>;
export type RuntimePlaytestInteractIsBoolean = Assert<
  Equal<RuntimePlaytestInputRequest['interact'], boolean>
>;
export type RuntimePlaytestDropIsBoolean = Assert<
  Equal<RuntimePlaytestInputRequest['drop'], boolean>
>;
export type RuntimePlaytestAbilitiesIsArray = Assert<
  Equal<
    RuntimePlaytestInputRequest['abilities'],
    readonly ('dash' | 'shield-burst' | 'scan-pulse' | 'trap' | 'decoy')[]
  >
>;
