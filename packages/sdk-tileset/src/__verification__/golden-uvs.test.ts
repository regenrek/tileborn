...
describe("golden UV layout tables", () => {
  it("matches committed atlas slice and frame index goldens", () => {
    ...
    assertGoldenMatch("uvs/grid-32-margin-spacing.json", uvs["grid-32-margin-spacing"], grid32MarginSpacingGolden);
    assertGoldenMatch("uvs/meadow-frame-index.json", uvs["meadow-frame-index"], meadowFrameIndexGolden);
  });
});
