...
export type AutotileResolveLookups = {
  readonly patternForMask?: (
    rule: AutotileRule,
    mask: number,
  ) => ReadonlyArray<TileId> | undefined;
  readonly contributingNeighbors?: ReadonlyArray<ContributingNeighbor>;
  readonly variantHooks?: ReadonlyArray<VariantHook>;
};
...
): { readonly tileIds: ReadonlyArray<TileId>; readonly matchedPatternIndex: number | null; readonly fallback: boolean } => {
