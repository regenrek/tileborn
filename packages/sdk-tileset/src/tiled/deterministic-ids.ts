...
import { AnimationId, AutotileRuleId, TilesetId, VariantFilterId } from '../schemas/ids.js';
...
export const deterministicPlaceableId = (seed: string): PlaceableId =>
  makePlaceableId(uuidFromSeed(seed));
