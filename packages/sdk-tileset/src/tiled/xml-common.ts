...
export const convertTiledXmlTileset = (root: TiledXmlNode): TiledJsonTileset => {
  ...
  return {
    type: 'tileset',
    ...(optionalString(root.version) === undefined
      ? {}
      : { version: optionalString(root.version) }),
    ...(optionalString(root.tiledversion) === undefined
      ? {}
      : { tiledversion: optionalString(root.tiledversion) }),
    ...
    ...(optionalInteger(root.spacing) === undefined
      ? {}
      : { spacing: optionalInteger(root.spacing) }),
    ...(image ? { image: requiredString(image.source, 'tileset.image.source') } : {}),
    ...(image && optionalInteger(image.width) !== undefined
      ? { imagewidth: optionalInteger(image.width) }
      : {}),
    ...(image && optionalInteger(image.height) !== undefined
      ? { imageheight: optionalInteger(image.height) }
      : {}),
    ...
    ...(convertProperties(childNode(root.properties, 'properties') ?? root.properties) === undefined
      ...
      : {
          properties: convertProperties(
            childNode(root.properties, 'properties') ?? root.properties,
          ),
        }),
...
export const convertTiledXmlMap = (root: TiledXmlNode): TiledJsonMap =>
  ({
    ...
    ...(optionalTiledBoolean(root.infinite) === undefined
      ? {}
      : { infinite: optionalTiledBoolean(root.infinite) }),
...
const layerBase = (node: TiledXmlNode) => ({
  ...
  ...(optionalTiledBoolean(node.visible) === undefined
    ? {}
    : { visible: optionalTiledBoolean(node.visible) }),
...
const convertTile = (value: unknown): TiledJsonTile => {
  ...
  return {
    ...
    ...(image && optionalInteger(image.height) !== undefined
      ? { imageheight: optionalInteger(image.height) }
      : {}),
    ...(optionalNumber(node.probability) === undefined
      ? {}
      : { probability: optionalNumber(node.probability) }),
    ...(toArray(childNode(node.animation, 'animation')?.frame).length > 0
      ...
      : {}),
    ...(node.objectgroup === undefined
      ? {}
      : { objectgroup: convertTiledXmlObjectGroup(node.objectgroup) }),
    ...(convertProperties(childNode(node.properties, 'properties') ?? node.properties) === undefined
      ? {}
      : {
          properties: convertProperties(
            childNode(node.properties, 'properties') ?? node.properties,
          ),
        }),
  } as TiledJsonTile;
};
...
const convertObject = (value: unknown): TiledJsonObject => {
  ...
  return {
    ...
    ...(polyline
      ? { polyline: parsePoints(requiredString(polyline.points, 'polyline.points')) }
      : {}),
    ...(convertProperties(childNode(node.properties, 'properties') ?? node.properties) === undefined
      ? {}
      : {
...
export const readTiledXmlLayerDataNode = (
  ...
  return {
    ...(optionalString(data.encoding) === undefined
      ? {}
      : { encoding: optionalString(data.encoding) }),
    ...(optionalString(data.compression) === undefined
      ? {}
...
const convertProperties = (value: unknown): readonly TiledJsonProperty[] | undefined => {
  const properties = toArray(
    childNode(value, 'properties')?.property ?? requiredNodeOrUndefined(value)?.property,
  ).map(convertProperty);
...
export const xmlTilesetRoot = (value: unknown): TiledXmlNode | undefined =>
  childNode(value, 'tileset');
