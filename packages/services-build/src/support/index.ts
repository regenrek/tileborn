...
export class SupportService extends Context.Service<SupportService, {
  ...
  ) => Effect.Effect<SupportBundle, ServicesBuildError | SupportBundleNotFoundError | IntegrityMismatchError>;
  readonly listBundles: () => Effect.Effect<readonly SupportBundle[], ServicesBuildError | IntegrityMismatchError>;
...
export const SupportServiceLive = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const writeBundle = Effect.fn("SupportService.writeBundle")(function* (options: SupportBundleOptions) {
    ...
    const deleteBundle = Effect.fn("SupportService.deleteBundle")(function* (bundleId: SupportBundleId) {
