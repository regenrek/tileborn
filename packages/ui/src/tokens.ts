...
export const typography = {
  ...
  panelTitle:
    "text-caption font-semibold tracking-wider uppercase text-muted-foreground",
  panelTitleAccent:
    "text-caption font-semibold tracking-wider uppercase text-primary",
  subsectionLabel:
    "text-2xs font-medium tracking-wide uppercase text-muted-foreground",
  rowTitle: "text-caption font-medium text-foreground",
  rowMeta: "text-2xs text-muted-foreground",
  inlineHint:
    "text-2xs tracking-wide text-muted-foreground",
  ...
  sectionLabel:
    "text-caption font-semibold tracking-wide uppercase text-muted-foreground",
  sectionLabelAccent:
    "text-caption font-semibold tracking-wide uppercase text-primary",
  sectionLabelMicro:
    "text-2xs font-medium tracking-wide uppercase text-muted-foreground",
  bodyCompact: "text-caption text-muted-foreground",
  bodyMicro: "text-2xs text-muted-foreground",
  shortcut:
    "text-2xs tracking-widest text-muted-foreground",
} as const
